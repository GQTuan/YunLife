...
<?php $this->regCss('common.css') ?>
 ...
 div{
  ...
  .assets-wrap .coin-asset {
    width: 6em;
    padding: 4px 0 4px 2px;
    border-left: 1px solid #eee;
    }
    .btn-withdraw-wrap .withdraw {
        padding-left: 12px;
    }
</style>
    <div>
        <div class="transaction indexContent">
            ...
            <div class="boxflex assets-wrap">
                ...
                <div class="cash-asset box_flex_1">
                    <div class="asset">
                        <p class="lf">
                            资产<span id="userProfit" style="color:#eb7d12;"><?= u()->account<0?'异常':u()->account - u()->blocked_account ?></span>元
                        </p>
                        <p class="rt">
                            积分<span class="jifen"><?= floatval(u()->integral) ?></span>
                        </p>
                    </div>
                    <div style="margin-top:3px;" class="btn-withdraw-wrap">
                        ...
                        <div class="withdraw overallPsd" data-url="<?= url(['shop/cashback']) ?>"><span>返利</span></div>
                        <div class="withdraw overallPsd" data-url="<?= url(['shop/initback']) ?>"><span>积分兑换</span></div>
            ...
            <div class="goodslist-wrap">
                <ul class="boxflex selectProcut">
                    ...
                    <?php $class='down';if ($value['price'] > $value['close']){ $class = 'up';} $price=$value['price']; if($value['source'] == 1 && (date('w') == 0 || (date('G') > 4 && date('w') == 6))){$price = '休市';}?>
            ...
            <div class="deal-btn-wrap <?= $disClass ?>">
                ...
                <p><?= config('web_trade_time', '商品时间：周一~周五早上6:00~凌晨2:00 周末休市') ?></p>
            </div>
