...
class WebController extends \yii\web\Controller
{
    ...
    {
        $allowActions = ['notify', 'index', 'ajax-update-status', 'wxtoken', 'wxcode', 'card', 'test', 'hx-weixin', 'zynotify', 'tynotify', 'verify-code', 'open-notify', 'bxnotify', 'zbnotify', 'new-bxnotify', 'hm-alipaynotify'];
